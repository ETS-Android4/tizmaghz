...
package com.app.sherafat.ali.tizmaghz.app.utils;
...
public class TinyDB {
    ...
    private static WeakReference<TinyDB> instance;

    public static TinyDB getInstance(Context context) {
        if (instance == null || instance.get() == null) {
            instance = new WeakReference<>(new TinyDB(context.getApplicationContext()));
        }
        return instance.get();
    }
...
//    }
    ...
    public void putListInt(String key, ArrayList<Integer> intList) {
        ...
        editor.putString(key, TextUtils.join("‚‗‚", myIntList)).apply();
    }
    ...
    public void putListDouble(String key, ArrayList<Double> doubleList) {
        ...
        editor.putString(key, TextUtils.join("‚‗‚", myDoubleList)).apply();
    }
